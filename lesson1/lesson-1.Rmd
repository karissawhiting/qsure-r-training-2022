...
1. Go to https://github.com/karissawhiting/qsure-case-study-2022 and click **Code > Download ZIP**

2. Create a new folder on your computer and name it "your-initials-case-study-2022"

3. Create subfolders within your project folder called: `admin`, `raw-data`, `scripts`, `data`, `outputs`

4. Create a new R Project in Rstudio from this folder (**File > New Project > Existing Directory**)
